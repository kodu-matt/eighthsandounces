<?php 
	...
	$output .= "\t\t\t" . '</div>' . "\r\n";
	$output .= "\t\t\t\t" . '<p class="clear-btn">Clear</p>' . "\r\n";
	...
	$output .= "\t\t\t\t" . '<div class="similar-strain-button">
	            		<div id="address" style="display:none">
	            			<h3>Search Similar Strains</h3>
	            			<input type="text" autocomplete="off" class="product-search-box" placeholder="Search Strains" name="keyword" id="keyword" onkeyup="search_product()">
	            			 
	            			<div class="datafetch" id="datafetch">Search results will appear here</div>
	            		</div>' . "\r\n";
	$output .= "\t" . '</div>' . "\r\n";
