...
<div class="wciz-feeds__content  wciz-content-wrap wciz-feed__cf7-object">
	<a class="wciz-feeds__header-link active">
		<?php esc_html_e( 'CF7 Feed', 'woo-crm-integration-for-zoho' ); ?>
	</a>
	<div class="wciz-feeds__meta-box-main-wrapper">
		<div class="wciz-feeds__meta-box-wrap">
		<div class="wciz-form-wrapper">
				<label><?php esc_html_e( 'Check if CF7 Feed', 'woo-crm-integration-for-zoho' ); ?></label>
