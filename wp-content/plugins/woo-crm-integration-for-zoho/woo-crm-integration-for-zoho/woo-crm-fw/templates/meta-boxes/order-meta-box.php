...
<div id="wciz-shop-order-meta-box-wrap"  data-object_id_delete ="<?php echo esc_html( $post_order_id ); ?>" >
	<div class="select-feed-wrap">
		<select id="wciz-zoho-manual-sync-select" style="margin: 10px 0px;" >
		...
		<a href="#" class="button" id="wciz-zoho-manual-sync-button">
			<?php esc_html_e( 'Sync manually', 'woo-crm-integration-for-zoho' ); ?>
		</a>
	</div>
</div>
